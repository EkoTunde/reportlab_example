...
class PDFReport(object):
    ...
    def get_filename(self):
        ...
        if self.DEBUG:
            return 'example.pdf'
        return f'{date}_PRESUPUESTO_ENTRETELAS_{first}_{last}.pdf'

    def create_pdf(self):
        self.pdf = canvas.Canvas(self.get_filename(), pagesize=A4)
    ...
    def set_footer(self, expiration_date):
        ...
        self.pdf.setFont("Helvetica", 12)
        self.pdf.drawCentredString(
            (self.MAX_WIDTH/2)+7.5, 20.5, "/entretelas.mlh")
        ig = "instagram.jpg"
    ...
    def get_corp_info(self, style):
        text = """
        <strong>La dueña de la marca</strong><br/>
        <br/>
        Tel. +54 9 11 1122--3344<br/>
        correo_entretelas@gmail.com<br/>
        Balvanera<br/>
        CABA (Argentina)<br/>
        """
...
report = PDFReport(
    ...
    "14/06/2021",
    {
        ...
        'last': "Pepinillos",
        'tel': 1123456789,
        'email': 'carlospepinillos418@gmail.com',
        'city': 'Retiro',
        'state': 'CABA',
    },
    [
